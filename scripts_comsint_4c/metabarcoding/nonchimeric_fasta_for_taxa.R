...
writeXStringSet(filepath = 'C:/Users/natal/Documents/LIIGH/results/results_comsint_4c/analisis/metabarcoding/batch_0/nonchimeric/nonchimeric_seqs_filtered.fasta',
                  filtered_seqs)
