#!/bin/bash                                                             
#SBATCH --job-name=metabarcoding		                                          # Job name
#SBATCH --chdir=/mnt/data/sur/users/nsaid/4c/metabarcoding/analysis/prueba   	# ruta para guardar todo el output			                                            
...
-o abundance_table_open/feature-table-open.tsv --to-tsv
