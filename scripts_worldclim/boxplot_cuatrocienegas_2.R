...
latitude = c(26.848936419081998)
longitude = c(-102.13452499885801)
...
forecast_2021<-forecast_2021[,]-bioclim_1970[,2]; forecast_2021$year<-"2021-2040"; forecast_2021$ubi<-c("Poza Churince")
forecast_2041<-forecast_2041[,]-bioclim_1970[,2]; forecast_2041$year<-"2041-2060"; forecast_2041$ubi<-c("Poza Churince")
forecast_2061<-forecast_2061[,]-bioclim_1970[,2]; forecast_2061$year<-"2061-2080"; forecast_2061$ubi<-c("Poza Churince")
...
plot<-ggplot(forecast_all, aes(year, value)) + geom_boxplot() +
  ...
  labs(caption = "Boxplot of the temperature difference in years 2021-2040, 2041-2060, and 2061-2080 
  compared to the years 1970-2000 for Poza Churince located in Cuatro Ciénegas, Coahuila, Mexico.
  Temperature values were extracted from 25 CMIP-6 models available at: 
  https://www.carbonbrief.org/cmip6-the-next-generation-of-climate-models-explained/")


ggsave(plot, file="plot_cuatrocienegas_2.png", width = 15, height = 14, units = "cm")
